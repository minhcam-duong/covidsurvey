...
questions <- c("Pathogen contamination in food",
               "Poor hygiene in processed or ready-to-eat food",
               "Poor hygiene in meat & fresh produce",
               "Hormone in meat",
               "Pesticides in fresh produce",
               "Chemicals in meat & fresh produce",
               "Salt in processed or ready-to-eat food",
               "Sugar in processed or ready-to-eat food",
               "Fat in processed or ready-to-eat food")
...
fig1 <- ggplot(concern_vn, aes(x=value, y=survey_items)) + 
       ...
       annotate("text", x = c(1,2,3,4,5), y=8.8, label = response, size = 3.1) 
fig1
```
